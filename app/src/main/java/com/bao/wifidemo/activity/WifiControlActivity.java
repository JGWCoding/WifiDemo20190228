    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_connection_wifi:
                ...
                break;
            case R.id.tv_disconnection_wifi:    //断开你输入的
            ...
            case R.id.tv_wifi_message:
                String ip ="ip:"+wifiControlUtils.getWIFILocalIpAdress()+"\n\n";
                LogUtils.e(ip);
                tvWifiMessage.setText(ip+wifiControlUtils.getWifiInfo().toString());
                break;
        }
    }
